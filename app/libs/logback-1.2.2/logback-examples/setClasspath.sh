...
CLASSPATH="${CLASSPATH}:${LB_HOME}/logback-classic-1.2.2.jar"
CLASSPATH="${CLASSPATH}:${LB_HOME}/logback-core-1.2.2.jar"
CLASSPATH="${CLASSPATH}:${LB_HOME}/logback-examples/logback-examples-1.2.2.jar"
